...
//
              ...
              '("La primera programadora", "Pioneros", "Tecnologías", "none", "¡Agárrate! Ada Lovelace fue la primera programadora de la historia, ¡en 1843! Creó el primer algoritmo para ser procesado por una máquina. Ada, eres una leyenda. Esta visionaria vio el potencial de las computadoras más allá de los números.", "WomenInTech", "https://womenintech.com/ada-lovelace", "https://blogger.googleusercontent.com/img/a/placeholder6.jpg"),'
              //
              '("El padre del pingüino", "Pioneros", "Tecnologías", "none", "Linus Torvalds cambió el juego. Creó Linux en su habitación a los 21 años. Hoy, su sistema operativo domina servidores y supercomputadoras. ¡Poder al open source! Este finlandés demostró que la colaboración global puede crear maravillas tecnológicas.", "LinuxFoundation", "https://linuxfoundation.org/linus", "https://blogger.googleusercontent.com/img/a/placeholder7.jpg"),'
              //
              '("La reina de los compiladores", "Pioneros", "Tecnologías", "none", "Grace Hopper, la reina de los compiladores. Esta naval creó el primer compilador en 1952, sentando las bases de los lenguajes de programación modernos. ¡Una crack total! Además, popularizó el término bug en programación. ¡Genio y figura!", "CodePioneers", "https://codepioneers.com/grace-hopper", "https://blogger.googleusercontent.com/img/a/placeholder8.jpg"),'
              //
              '("El tejedor de la Web", "Pioneros", "Desarrollo web", "none", "Tim Berners-Lee inventó la World Wide Web en 1989. Sin él, no estarías leyendo esto. Lo mejor: la hizo libre y abierta para todos. ¡Gracias, Tim! Su visión conectó al mundo y revolucionó la comunicación global.", "WebFoundation", "https://webfoundation.org/tim", "https://blogger.googleusercontent.com/img/a/placeholder9.jpg"),'
              //
              '("JavaScript en 10 días", "Pioneros", "Desarrollo web", "none", "¿10 días para crear un lenguaje? Brendan Eich lo hizo con JavaScript en 1995. Hoy es el lenguaje más usado en desarrollo web. ¡Velocidad nivel: Eich! Su creación transformó la web de estática a dinámica e interactiva.", "JavaScriptHistory", "https://javascript.com/history", "https://blogger.googleusercontent.com/img/a/placeholder10.jpg"),'
              //
              '("El rockstar de los videojuegos", "Pioneros", "Desarrollo de videojuegos", "none", "John Carmack revolucionó los videojuegos 3D. Creó motores para Doom y Quake, sentando las bases de los FPS modernos. ¡Un verdadero rockstar del código! Sus innovaciones en gráficos 3D cambiaron para siempre la industria del gaming.", "GameDevLegends", "https://gamedevlegends.com/carmack", "https://blogger.googleusercontent.com/img/a/placeholder11.jpg"),'
              //
              '("Código lunar", "Pioneros", "Tecnologías", "none", "Margaret Hamilton lideró el equipo que escribió el software para el Apollo 11. Su código llevó al hombre a la luna. Margaret, ¡eres de otro planeta! Esta pionera acuñó el término ingeniería de software y revolucionó la programación.", "NASAHistory", "https://nasa.gov/margaret-hamilton", "https://blogger.googleusercontent.com/img/a/placeholder12.jpg"),'
              //
              '("El visionario de la nube", "Pioneros", "Tecnologías", "none", "Satya Nadella transformó Microsoft. Llevó la empresa a la nube, convirtiéndola en líder en IA y servicios cloud. ¡Un jefe que sabe hacia dónde sopla el viento! Su liderazgo cambió la cultura de Microsoft y revitalizó la compañía.", "MicrosoftStory", "https://microsoft.com/satya", "https://blogger.googleusercontent.com/img/a/placeholder13.jpg"),'
              //
              '("El regalo navideño que conquistó el mundo", "Pioneros", "Tecnologías", "none", "Guido van Rossum creó Python como hobby navideño. Hoy es el lenguaje más popular en IA y data science. ¡Guido, has cambiado el juego! Su filosofía de diseño, enfocada en la legibilidad, revolucionó la forma de programar.", "PythonHistory", "https://python.org/guido", "https://blogger.googleusercontent.com/img/a/placeholder14.jpg"),'
              //
              '("El mago de la manzana", "Pioneros", "Tecnologías", "none", "Steve Wozniak, el genio detrás del Apple I y II. Este ingeniero hizo realidad la computadora personal. Sin él, quizás no tendrías un smartphone. ¡Gracias, Woz! Su visión de llevar la tecnología a los hogares cambió el mundo para siempre.", "AppleOrigins", "https://apple.com/wozniak", "https://blogger.googleusercontent.com/img/a/placeholder15.jpg"),'

              // Motivacional
              //
              '("Motivación a prueba de bugs", "Motivacional", "Habilidades de TI", "none", "El éxito en programación no es para genios, es para tercos. Si te estancas, respira hondo y sigue dandole. Cada error te acerca a la solución. ¡A rockear ese código! La persistencia es tu superpoder en este mundo de bits y bytes.", "CodeMotivation", "https://codemotivation.com", "https://blogger.googleusercontent.com/img/a/placeholder1.jpg"),'
              //
              '("El código no tiene límites", "Motivacional", "Desarrollo web", "none", "Olvídate del síndrome del impostor. Cada línea de código que escribes te hace más pro. Atrévete a tomar proyectos que te asusten. Tu potencial es infinito, así que a programar sin miedo.", "WebDevMotivators", "https://webdevmotivators.com", "https://blogger.googleusercontent.com/img/a/placeholder2.jpg"),'
              //
              '("Apps que cambian el mundo", "Motivacional", "Desarrollo mobile", "none", "Tú puedes crearlas. La clave no es el talento, es la constancia. Dedica tiempo cada día, y verás cómo tu código se vuelve imparable. Cada línea de código es un paso hacia la revolución mobile.", "MobileDevLife", "https://mobiledevlife.com", "https://blogger.googleusercontent.com/img/a/placeholder3.jpg"),'
              //
              '("IA: Tu aliada, no tu reemplazo", "Motivacional", "IA", "none", "La IA no reemplazará a los programadores creativos. Sé el que inventa, no el que copia. Experimenta, combina tecnologías, crea algo único. El futuro es de los valientes. Tu creatividad es el ingrediente secreto que ninguna IA puede replicar.", "AICreators", "https://aicreators.com", "https://blogger.googleusercontent.com/img/a/placeholder4.jpg"),'
              //
              '("Unidos por el código", "Motivacional", "Habilidades de TI", "none", "Olvida el lobo solitario. En tech, el trabajo en equipo es poder. Aprende a colaborar, comparte conocimientos, y verás cómo tus proyectos se disparan. ¡Unidos somos imparables! El mejor código es el que se escribe en equipo.", "TechTeamPower", "https://techteampower.com", "https://blogger.googleusercontent.com/img/a/placeholder5.jpg"),'
...
//
              '("El temido memory leak", "Conceptos", "Desarrollo de software", "none", "Es como una gotera en tu programa. Poco a poco, va consumiendo la memoria de tu computadora hasta que no queda nada. Es silencioso, lento y mortal. Antes de que te des cuenta, tu programa está más hinchado que un globo a punto de explotar.", "Microsoft Learn", "https://learn.microsoft.com/en-us/troubleshoot/developer/visualstudio/cpp/libraries/memory-leaks-crt-libraries", "https://blogger.googleusercontent.com/img/a/AVvXsEi3qwlPkZPAqg4maP8J-XadQ8f6gemPWxJPX4sVsoUWsXpUPT6z1dMAhzyMvtUdS4WyNVpR7VL2Ttq5Y7yru3J4K0gl7q5_0AQfH5xdN3-_UlT7qxqP6CShiQWvtjsgyKlTdPvaj0aGRcBYjztVvYOtMiiFG2CHzXDpp7ps0Z-8TL-2c7lM__grQtzP"),'
//
...
//
              ...
              //
              '("El lenguaje Whitespace", "Curiosidades", "Tecnologias", "Whitespace", "Whitespace es un lenguaje de programación que usa solo espacios, tabulaciones y saltos de línea.", "GeeksforGeeks", "https://www.geeksforgeeks.org/whitespace-programming-language/", "https://blogger.googleusercontent.com/img/a/AVvXsEi26ydQXOO0SnyUXdZDSMDHWEMotIaV6XAO3dhOv-HJBHDWePJ3hx1dsKDgW_TaSlS1zuuwqFYD8qiy-JddsKjr9CJNUOECudcl57yLpnTHtZJL3gvrusytt7bY0_07ZM9audO3U6uzsDDVLVV4aPM2hzBVDchNEX8Y7cpiSZu7MKM6OzzkI-BdR1tE"),'
              //
